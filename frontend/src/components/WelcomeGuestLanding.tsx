...
const PLATFORM_PILLARS = [
  {
    ...
    bgLight: "bg-emerald-100 dark:bg-emerald-950/60 text-emerald-800 dark:text-emerald-300 border-emerald-300 dark:border-emerald-800",
  ...
  },
  {
    ...
    bgLight: "bg-orange-100 dark:bg-orange-950/60 text-orange-800 dark:text-orange-300 border-orange-300 dark:border-orange-800",
  ...
  },
  {
    ...
    bgLight: "bg-amber-100 dark:bg-amber-950/60 text-amber-800 dark:text-amber-300 border-amber-300 dark:border-amber-800",
  ...
  },
  {
    ...
    bgLight: "bg-blue-100 dark:bg-blue-950/60 text-blue-800 dark:text-blue-300 border-blue-300 dark:border-blue-800",
    title: "Verified Vendor Ecosystem",
    desc: "Curated local Dombivli service partners, verified security guards, housekeeping staff, and resident-reviewed contractors.",
  },
];
...
export default function WelcomeGuestLanding({
  ...
  return (
    <div className="space-y-10 py-4 max-w-5xl mx-auto">
      ...
      <div className="card p-8 sm:p-10 bg-gradient-to-br from-amber-500/15 via-orange-500/10 to-amber-500/5 dark:from-stone-950 dark:via-stone-900 dark:to-amber-950 text-stone-900 dark:text-white border-amber-300/80 dark:border-stone-800 shadow-xl dark:shadow-2xl rounded-3xl relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-100 dark:bg-amber-500/20 text-amber-900 dark:text-amber-300 border border-amber-300 dark:border-amber-500/30 text-xs font-mono font-extrabold uppercase tracking-wider shadow-xs">
              <span className="text-sm">🪔</span>
              <span>RUNWAL GARDENS TOWER 24 • RESIDENT HUB</span>
            </div>

            <div className="flex items-center gap-1.5 text-xs text-emerald-800 dark:text-emerald-400 font-mono font-extrabold bg-emerald-50 dark:bg-white/5 px-3 py-1 rounded-full border border-emerald-200 dark:border-white/10 shadow-xs">
          ...
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-stone-900 dark:text-white tracking-tight leading-tight">
              ...
              <span className="bg-gradient-to-r from-orange-600 via-amber-600 to-amber-500 dark:from-amber-400 dark:via-orange-400 dark:to-amber-200 bg-clip-text text-transparent">
                Co-Operative Housing Platform
              </span>
            </h1>
            <p className="text-sm sm:text-base text-stone-700 dark:text-stone-300 max-w-2xl leading-relaxed font-medium">
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-[#1a1512] border border-stone-200 dark:border-[#383028] shadow-md dark:shadow-none transition-all relative overflow-hidden">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <span className="text-lg">{currentQuote.icon}</span>
                <span className="text-[10px] font-mono font-extrabold uppercase tracking-widest text-amber-800 dark:text-amber-400 bg-amber-100 dark:bg-amber-400/10 px-2 py-0.5 rounded-md border border-amber-300 dark:border-amber-400/20">
                  {currentQuote.tag}
                </span>
              </div>
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="p-1 rounded-lg bg-stone-100 hover:bg-stone-200 dark:bg-white/10 dark:hover:bg-white/20 text-stone-700 dark:text-stone-300 hover:text-stone-900 dark:hover:text-white transition-all shadow-xs"
                  title="Previous Quote"
                >
                  <ChevronLeft className="w-4 h-4" />
                </button>
                <span className="text-[10px] font-mono text-stone-500 dark:text-stone-400 px-1 font-bold">
            ...
            >
              <p className="text-base sm:text-lg font-extrabold text-stone-900 dark:text-white italic leading-relaxed">
                &ldquo;{currentQuote.quote}&rdquo;
              </p>
              <p className="text-xs text-amber-800 dark:text-amber-200/80 font-mono font-bold">
                — {currentQuote.author}
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <button
              ...
              className="btn-primary py-3 px-6 text-sm font-extrabold flex items-center gap-2 shadow-xl shadow-orange-600/20 hover:shadow-orange-600/30"
            >
            ...
            <button
              ...
              className="px-5 py-3 rounded-2xl bg-white hover:bg-stone-50 dark:bg-white/10 dark:hover:bg-white/20 border border-stone-300 dark:border-white/20 text-stone-900 dark:text-white text-sm font-extrabold transition-all flex items-center gap-2 shadow-sm"
            >
              <UserPlus className="w-4 h-4 text-orange-600 dark:text-amber-400" />
      ...
      <div className="card p-6 bg-white dark:bg-[#1b1613] border-stone-200 dark:border-[#383028] shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
          ...
          <button
            ...
            className="p-4 rounded-2xl bg-stone-50 hover:bg-amber-50/70 dark:bg-[#221c18] dark:hover:bg-[#2a221d] border border-stone-200 dark:border-[#3d332a] hover:border-amber-400 transition-all text-left flex items-center justify-between group shadow-xs"
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-orange-100 dark:bg-orange-950/80 text-orange-700 dark:text-orange-300 flex items-center justify-center font-bold text-lg shadow-sm border border-orange-200 dark:border-transparent">
                👑
              </div>
              <div>
            ...
            <div className="text-right shrink-0">
              <span className="inline-flex items-center gap-1 text-[11px] font-extrabold text-orange-600 dark:text-orange-400">
                <span>Enter</span>
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-emerald-100 dark:bg-emerald-950/80 text-emerald-700 dark:text-emerald-300 flex items-center justify-center font-bold text-lg shadow-sm border border-emerald-200 dark:border-transparent">
                🏡
              </div>
              <div>
      ...
      <div className="space-y-4">
        <div className="text-center space-y-1">
          ...
          <p className="text-xs sm:text-sm text-stone-600 dark:text-stone-400 max-w-xl mx-auto font-medium">
      ...
      <div className="p-4 rounded-2xl bg-amber-100/70 dark:bg-amber-500/10 border border-amber-300 dark:border-amber-900/40 text-center space-y-1 text-xs text-amber-950 dark:text-amber-300 shadow-xs">
        <p className="font-extrabold flex items-center justify-center gap-1.5 text-amber-900 dark:text-amber-300">
          <Shield className="w-4 h-4 text-amber-700 dark:text-amber-400" />
          <span>Restricted Society Member Network</span>
        </p>
        <p className="text-[11px] text-stone-700 dark:text-stone-400 font-medium">
